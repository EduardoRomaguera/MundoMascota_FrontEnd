...
const modificarUsuario = async(pnombreNegocio, pnombre, papellido1, papellido2, ptipoId, pidentificacion, pnacimiento, pedad, pcorreo, ptelefono, pprovincia, pcanton, pdistrito, potrasSenas, phorario, penlaceFacebook, penlaceInstagram, penlaceTiktok, pnombreR, papellido1R, papellido2R, pcorreoR, pubicacion) => {

  await axios({
          method: 'put',
          url: 'http://localhost:3000/api/cambiar-datos',
          responseType: 'json',
          data: {
...
const registrar = () => {
  ...
  modificarUsuario(nombreNegocio, nombre, apellido1, apellido2, tipoId, identificacion, nacimiento, edad, correo, telefono, provincia, canton, distrito, otrasSenas, horario, enlaceFacebook, enlaceInstagram, enlaceTiktok, nombreR, apellido1R, apellido2R, correoR, ubicacion);
};
...
/// FIN DE CODIGO DE PAGINA DE REGISTRO
  ...
  const sustituirDatos = () => {
    ...
    const inputnombreNegocio = document.querySelector('#txt-nombre-negocio-pr');
    const inputnombreNegocio2 = document.querySelector('#txt-nombreNegocio2');
    const inputnombre = document.querySelector('#txt-nombre-pr');
    const inputapellido1 = document.querySelector('#txt-apellido1-pr');
    const inputapellido2 = document.querySelector('#txt-apellido2-pr');
    const inputtipoId = document.querySelector('#txt-tipo-id-pr');
    const inputidentificacion = document.querySelector('#txt-identificacion-pr');
    const inputnacimiento = document.querySelector('#txt-nacimiento-pr');
    const inputedad = document.querySelector('#txt-edad-pr');
    const inputcorreo = document.querySelector('#txt-correo-pr');
    const inputtelefono = document.querySelector('#txt-teléfono-pr');
    const inputprovincia = document.querySelector('#txt-provincia-pr');
    const inputcanton = document.querySelector('#txt-canton-pr');
    const inputcanton2 = document.querySelector('#txt-canton-pr2');
    const inputdistrito = document.querySelector('#txt-distrito-pr');
    const inputdistrito2 = document.querySelector('#txt-distrito-pr2');
    const inputotrasSennas = document.querySelector('#txt-sennas-pr');
    const inputhorario = document.querySelector('#txt-horario-pr');
    const inputenlaceFacebook = document.querySelector('#txt-enlaceFacebook-pr');
    const inputenlaceFacebook2 = document.querySelector('#txt-enlaceFacebook-pr');
    const inputenlaceInstagram = document.querySelector('#txt-enlaceInstagram-pr');
    const inputenlaceInstagram2 = document.querySelector('#txt-enlaceInstagram-pr');
    const inputenlaceTikTok = document.querySelector('#txt-enlaceInstagram');
    const inputenlaceTikTok2 = document.querySelector('#txt-enlaceInstagram');
    const inputUbicacion = document.querySelector('#txt-enlaceMaps-pr');
    const inputUbicacion2 = document.querySelector('#txt-enlaceMaps-pr');
    ...
    inputnombreNegocio.value = datos.nombreNegocio;
    // inputnombreNegocio2.value = datos.nombreNegocio;
    ...
    inputhorario.value = datos.horario;
    ...
    inputotrasSennas.value = datos.otrasSenas;
    inputenlaceFacebook.value = datos.enlaceFacebook;
    // inputenlaceFacebook2.href = datos.enlaceFacebook;
    inputenlaceInstagram.value = datos.enlaceInstagram;
    // inputenlaceInstagram2.href = datos.enlaceInstagram;
    inputEnlaceTiktok.value = datos.enlaceTiktok;
    // inputenlaceTikTok2.href = datos.enlaceTiktok;
    // inputUbicacion.value = datos.ubicacions;
    inputUbicacion2.value = datos.ubicacion;
    inputNombreRepPr.value = datos.nombreR;
    let apellidoR = datos.apellido1R;
    apellidoR = apellidoR.concat(" ");
    apellidoR = apellidoR.concat(datos.apellido2R);
    inputApellido1RepPr.value = datos.apellido1R;
    inputApellido2RepPr.value = datos.apellido2R;
    inputCorreoRepPr.value = datos.correoR;
  }